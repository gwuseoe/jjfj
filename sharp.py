...
TOKEN = '7342907950:AAGeZxiIVvHkkBLRaJn0fwjyZyrhd_Cj5Oc'
ADMIN_USER_ID = 5160972276
...
def approve_or_disapprove_user(message):
    ...
    if user_id != ADMIN_USER_ID:
        bot.send_message(chat_id, f"🚫 *Access Denied. Only {SMOKIE} controls this realm.*", parse_mode='Markdown')
        return
